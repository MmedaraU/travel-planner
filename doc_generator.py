...
def generate_all_executive_profiles_doc(profiles):
    ...
    for p in profiles:
        row_cells = table.add_row().cells
        row_cells[0].text = p.get("Name", "")
        row_cells[1].text = p.get("Email", "")
        row_cells[2].text = p.get("Company", "")
        row_cells[3].text = p.get("Timezone", "")
        row_cells[4].text = p.get("Seat Preference", "")
        row_cells[5].text = p.get("Passport Number", "")
        # Get memberships as a string
        mems = p.get("Memberships", "")
        row_cells[6].text = mems
        row_cells[7].text = p.get("Meal Preference", "")
